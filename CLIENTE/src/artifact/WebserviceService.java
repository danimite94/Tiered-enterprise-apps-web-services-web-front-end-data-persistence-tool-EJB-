 ...
 * 
 */
@WebServiceClient(name = "webserviceService", targetNamespace = "http://webser/", wsdlLocation = "http://localhost:8080/webservicee/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://webser/", "webserviceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservicee/webservice?wsdl");
    ...
    public Webservice getWebservicePort() {
        return super.getPort(new QName("http://webser/", "webservicePort"), Webservice.class);
    }
    ...
    public Webservice getWebservicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webser/", "webservicePort"), Webservice.class, features);
    }
